...
local library = {
    ...
    signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/namyami/fixed_ui_or_random_stuff/refs/heads/main/utility/signal.lua'))();
    open = false;
    opening = false;
    hasInit = false;
...
function library:CreateSettingsTab(menu)
    ...
    mainSection:AddButton({text = 'Copy Discord', flag = 'copydiscord', callback = function()
        setclipboard('discord.gg/y8XvgZfRE8')
    end})
    ...
    mainSection:AddButton({text = 'Copy Job ID', callback = function()
    ...
    mainSection:AddToggle({text = 'Keybind Indicator', flag = 'keybind_indicator', state = false, callback = function(bool) 
