...
local library = {
    ...
    signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/patternscan/asdasdasddasd/main/signal.lua'))();
    open = false;
    opening = false;
    hasInit = false;
