...
do
    ...
    utility.vozoid_tween = loadstring(game:HttpGet("https://raw.githubusercontent.com/inveris1337/releases/refs/heads/main/modules/tween.lua"))()
...
local section1 = tab1:Section({name = "Toggles", side = "left"})
...
local toggleeee = section1:Toggle({
    name = "coolr",
    def = false,
})
