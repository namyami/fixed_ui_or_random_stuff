...
--local themes = {}
local theme = {
    accent = Color3.fromRGB(128,18,255),
...
do
    ...
    function library:New(info)
		local info = info or {}
        local name = info.name or info.Name or "ZeeBot"
        local title = info.title or info.Title or "ZeeBot"
        ...
        function window:Watermark(info)
            ...
            --
            utility:LoadImage(watermark__gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
            --
            ...
            function window.watermark:SetText(text)
                if watermark_title then
                    watermark_title.Text = text
            ...
            --
            --[[spawn(function()
            (we dont play dh anyways)
                while wait(0.1) do
                    watermark_title.Text = string.format("ZeeBot | Da Hood | Private | Ping : " .. tostring(library.shared.ping) .. "ms | FPS : " .. tostring(library.shared.fps), window.name)
                    window.watermark:UpdateSize()
                end
            end)]]
            --
        ...
        function window:NotificationList(info)
            ...
            function window.notificationlist:AddNotification(info)
                ...
                --
                utility:LoadImage(notify__gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
                --
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
        --
        ...
        function toggle:Set(bool)
            if bool ~= nil then
                toggle.current = bool
                toggle_frame.Color = toggle.current and theme.accent or theme.light_contrast
                toggle_inline.Color = toggle.current and Color3.fromHSV(theme.accent:ToHSV()) or theme.inline
        ...
        library.began[#library.began + 1] = function(Input)
            ...
            and toggle_outline.Visible 
            and window.isVisible 
            and page.open 
            and utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + toggle.axis, section.section_frame.Position.X + section.section_frame.Size.X - toggle.addedAxis, section.section_frame.Position.Y + toggle.axis + 15}) 
        ...
        function toggle:Colorpicker(info)
            ...
            --
            if transp then
                utility:LoadImage(colorpicker__transparency, "cptransp", "https://github.com/inveris1337/storage/blob/main/image/kNGuTlj.png?raw=true")
            end
            utility:LoadImage(colorpicker__gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
            --
                    ...
                    elseif utility:MouseOverDrawing({section.section_frame.Position.X + (section.section_frame.Size.X - (colorpicker.index == 0 and (30 + 4 + 2) or (64 + 4 + 2))), section.section_frame.Position.Y + colorpicker.axis, section.section_frame.Position.X + section.section_frame.Size.X - (colorpicker.index == 1 and 36 or 0), section.section_frame.Position.Y + colorpicker.axis + 15}) and not window:IsOverContent() then
                        if not colorpicker.open then
                            ...
                            if transp then
                                ...
                                --
                                utility:LoadImage(colorpicker_open_transparency_image, "transp", "https://github.com/inveris1337/storage/blob/main/image/ncssKbH_d.webp?raw=true")
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
        --
    ...
    function sections:Button(info)
        ...
        --
        utility:LoadImage(button_gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
        --
        library.began[#library.began + 1] = function(Input)
    ...
    function sections:Textbox(info)
        ...
        --
        utility:LoadImage(text_gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
        --
    ...
    function sections:Dropdown(info)
        ...
        utility:LoadImage(dropdown__gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
        --
    ...
    function sections:Multibox(info)
        ...
        utility:LoadImage(multibox__gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
        --
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + 15 +  20}) and not window:IsOverContent() then
                    if not multibox.open then
                        ...
                        for i,v in pairs(options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")]]
                            --
    ...
    function sections:ConfigBox(info)
        ...
        --
        utility:LoadImage(configLoader_gradient, "gradient", "https://github.com/inveris1337/storage/blob/main/image/boui_ui/j9y4dux.png?raw=true")
        --
...
local window = library:New({title = "ts fryin me why no body gaf :skull:"})
...
window:Initialize()
window.watermark:SetText("hello")
