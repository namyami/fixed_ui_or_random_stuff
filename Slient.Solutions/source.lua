...
if not isfolder(library.Folder) then
    ...
    writefile(library.Folder.."/Utility/Extension.lua",game:HttpGet("https://raw.githubusercontent.com/namyami/Roblox/main/Uis/Drawing/Silent/Utility/Extension.lua"))
    writefile(library.Folder.."/Utility/Signal.lua",game:HttpGet("https://raw.githubusercontent.com/namyami/Roblox/main/Uis/Drawing/Silent/Utility/Signal.lua"))
end
local drawing = loadstring(readfile(tostring(library.Folder.."/Utility/Extension.lua")))()
local themeobjects = {}
local images = {
    ['gradient3'] = "https://raw.githubusercontent.com/namyami/Roblox/main/Uis/Drawing/DeadCell/Assets/Gradient3.png",
    ['gradient4'] = "https://raw.githubusercontent.com/namyami/Roblox/main/Uis/Drawing/DeadCell/Assets/Gradient4.png",
    ['down'] = "https://raw.githubusercontent.com/namyami/Roblox/main/Uis/Drawing/DeadCell/Assets/Down.png",
    ['up'] = "https://raw.githubusercontent.com/namyami/Roblox/main/Uis/Drawing/DeadCell/Assets/Up.png",
}
...
function library:Window(cfg)
    ...
    function WindowTable:AddSettings()
        local Page3 = self:Page({Image = "https://github.com/namyami/Roblox/blob/main/Uis/Drawing/Silent/Assets/Settings.jpg?raw=true"})
